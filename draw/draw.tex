...
\newcommand{\diagram}[4]{ % arguments-to-math key: the four-tuple (p, a, b, r)
  ...
  \tikzmath{
    ...
    \innerdisctop = \abov + 1 + \shift; % un-wrapped n-value of the top (i.e. wrt. y-coordinate) of the innermost disc on the right
    ...
    % produce a coordinate given a pair and an axis (necessary because coordinates cannot be returned from functions)
